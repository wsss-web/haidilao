...
router.post('/userInfo', async(ctx,body) => {
    ...
    if(one_per.status == 3){
      var one_per = ctx.request.query
      var sql_reset = "update user set userId='"+ one_per.userId +"',password='"+ one_per.password +"',telnumber='"+ one_per.telnumber +"',nickname='"+ one_per.nickname +"',avatar='"+ one_per.avatar +"',mailbox='"+ one_per.mailbox +"'"
